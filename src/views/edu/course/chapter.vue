<template>
  ...
  <div class="app-container">
    ...
    <el-steps :active="2" process-status="wait" align-center style="margin-bottom: 40px;">
      ...
      <el-button type="text" @click="openChapterModel()" >添加章节</el-button>
...
export default {
  ...
  created() {
    ...
    if(this.$route.params && this.$route.params.id){
      ...
      this.getChapterVideo()  //根据课程id查询章节和小节
    }
  },
  ...
  methods: {
    ...
    //添加小节弹框的方法
    openVideo(chapterId){
      this.dialogVideoFormVisible=true //弹框
